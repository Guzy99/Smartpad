            ...
            <div class="col-md-12">
              <div class="card mt-150">
                <div class="card-header card-header-success">
                  ...
                  <p class="card-category"> <a href = "#" >Заполните все поля</a></p>
                </div>
                <div class="card-body ">
                  ...
                  <div class="col-md-6">
                      ...
                      <input type="submit" value = "Зарегистрироваться" class="btn btn-success textr pr-15">
                    <a href="logina.php" class="btn btn-success textr pr-15">Войти</a>
                    </div>
                  </form>
                </div>
              </div>
